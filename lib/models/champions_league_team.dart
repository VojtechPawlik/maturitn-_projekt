class ChampionsLeagueTeam {
  final String position;      // idx
  final String logo;          // logo URL
  final String team;          // name
  final String matches;       // played
  final String wins;          // wins
  final String draws;         // draws
  final String losses;        // losses
  final String scoresStr;     // scoresStr
  final String goalDifference; // goalConDiff
  final String points;        // pts
  ...
  factory ChampionsLeagueTeam.fromList(List<dynamic> row) {
