...
class EuropaLeagueScreen extends StatefulWidget {
  const EuropaLeagueScreen({super.key});

  @override
  State<EuropaLeagueScreen> createState() => _EuropaLeagueScreenState();
}

class _EuropaLeagueScreenState extends State<EuropaLeagueScreen> {
  List<EuropaLeagueTeam> teams = [];
  bool isLoading = true;
  String? error;
  ...
  Future<void> loadData() async {
    ...
    try {
      final data = await GoogleSheetsService.getEuropaLeagueData();
      setState(() {
        teams = data;
        isLoading = false;
      });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Europa League'),
