...
class _BundesligaScreenState extends State<BundesligaScreen> {
  ...
  Future<void> loadData() async {
    ...
    try {
      final data = await GoogleSheetsService.getBundesligaData();
      setState(() {
        teams = data;
        isLoading = false;
      });
                      ...
                      SingleChildScrollView(
                        ...
                        child: ConstrainedBox(
                          ...
                          child: DataTable(
                            ...
                            columns: const [
                              DataColumn(label: SizedBox(width: 35, child: Center(child: Text('#', style: TextStyle(fontWeight: FontWeight.bold))))),
                              DataColumn(label: Text('Tým', style: TextStyle(fontWeight: FontWeight.bold))),
                              DataColumn(label: SizedBox(width: 25, child: Center(child: Text('Z', style: TextStyle(fontWeight: FontWeight.bold))))),
                              DataColumn(label: SizedBox(width: 45, child: Center(child: Text('G', style: TextStyle(fontWeight: FontWeight.bold))))),
                              DataColumn(label: SizedBox(width: 25, child: Center(child: Text('B', style: TextStyle(fontWeight: FontWeight.bold))))),
                            ],
                            rows: teams.map((team) {
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildLegendItem('Konferenční liga', const Color(0xFF03A9F4)),
                            _buildLegendItem('Baráž o udržení', const Color(0xFFFF9800)),
